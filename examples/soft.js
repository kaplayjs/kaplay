...
const poly = createRegularPolygon(50, 8, 0);
...
const po = new Array(poly.length);
const pl = new Array(poly.length).fill(0);
const pa = new Array(poly.length * 3).fill(0);
...
const circ = pl.reduce((a, l) => a + l, 0);
