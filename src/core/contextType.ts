...
export interface KAPLAYCtx {
    ...
    onAdd: GameEventHandlers["onAdd"];
    onDestroy: GameEventHandlers["onDestroy"];
    onUse: GameEventHandlers["onUse"];
    onUnuse: GameEventHandlers["onUnuse"];
    onTag: GameEventHandlers["onTag"];
    onUntag: GameEventHandlers["onUntag"];
    /**
