...
var createEngine = function(gopt) {
    ...
    var _c = (0, fontCache_1.createFontCache)(),
        fontCacheC2d = _c.fontCacheC2d,
        fontCacheCanvas = _c.fontCacheCanvas;
    ...
    var assets = (0, asset_1.initAssets)(
        gfx,
        (_a = opt.spriteAtlasPadding) !== null && _a !== void 0 ? _a : 0,
    );
    var audio = (0, audio_1.initAudio)();
    var game = (0, game_1.createGame)();
    // Frame rendering
    var frameRenderer = (0, frameRendering_1.createFrameRenderer)(
        appGfx,
        game,
        (_b = opt.pixelDensity) !== null && _b !== void 0 ? _b : 1,
    );
    // Debug mode
    var debug = (0, debug_1.createDebug)(
        opt,
        app,
        appGfx,
        audio,
    ...
    return {
        ...
        k: null,
        startLoop: function() {
            (0, engineLoop_1.startEngineLoop)(
                app,
                game,
                assets,
                opt,
