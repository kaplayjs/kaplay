...
var FPSCounter = /** @class */ (function () {
    ...
    FPSCounter.prototype.tick = function (dt) {
        ...
        if (this.timer >= 1) {
            this.timer = 0;
            this.fps = Math.round(1 / (this.dts.reduce(function (a, b) { return a + b; }) / this.dts.length));
            this.dts = [];
        }
    };
    return FPSCounter;
...
var initApp = function (opt) {
        ...
        if (b) {
            try {
                ...
                if (res === null || res === void 0 ? void 0 : res.catch) {
                    res.catch(function (e) { return console.error(e); });
                }
            }
            catch (e) {
                console.error(e);
    ...
    function isGamepadButtonPressed(btn) {
        return btn === undefined
            ...
            : (0, sets_1.setHasOrIncludes)(state.mergedGamepadState.buttonState.pressed, btn);
    }
    function isGamepadButtonDown(btn) {
        return btn === undefined
            ? state.mergedGamepadState.buttonState.down.size > 0
            : (0, sets_1.setHasOrIncludes)(state.mergedGamepadState.buttonState.down, btn);
    }
    function isGamepadButtonReleased(btn) {
        return btn === undefined
            ? state.mergedGamepadState.buttonState.released.size > 0
            : (0, sets_1.setHasOrIncludes)(state.mergedGamepadState.buttonState.released, btn);
    }
    ...
    function getButton(btn) {
        var _a;
        return (_a = state.buttons) === null || _a === void 0 ? void 0 : _a[btn];
    }
    function setButton(btn, binding) {
        state.buttons[btn] = __assign(__assign({}, state.buttons[btn]), binding);
    }
    ...
    var onKeyDown = (0, overload_1.overload2)(function (action) {
        ...
        return state.events.on("keyDown", function (k) { return (0, sets_1.isEqOrIncludes)(key, k) && action(k); });
    });
    // key pressed is equal to the key by the user
    var onKeyPress = (0, overload_1.overload2)(function (action) {
        return state.events.on("keyPress", function (k) { return action(k); });
    }, function (key, action) {
        return state.events.on("keyPress", function (k) { return (0, sets_1.isEqOrIncludes)(key, k) && action(k); });
    });
    var onKeyPressRepeat = (0, overload_1.overload2)(function (action) {
        return state.events.on("keyPressRepeat", action);
    }, function (key, action) {
        return state.events.on("keyPressRepeat", function (k) { return (0, sets_1.isEqOrIncludes)(key, k) && action(k); });
    });
    var onKeyRelease = (0, overload_1.overload2)(function (action) {
        return state.events.on("keyRelease", action);
    }, function (key, action) {
        return state.events.on("keyRelease", function (k) { return (0, sets_1.isEqOrIncludes)(key, k) && action(k); });
    });
    var onMouseDown = (0, overload_1.overload2)(function (action) {
        return state.events.on("mouseDown", function (m) { return action(m); });
    }, function (mouse, action) {
        return state.events.on("mouseDown", function (m) { return (0, sets_1.isEqOrIncludes)(mouse, m) && action(m); });
    });
    var onMousePress = (0, overload_1.overload2)(function (action) {
        return state.events.on("mousePress", function (m) { return action(m); });
    }, function (mouse, action) {
        return state.events.on("mousePress", function (m) { return (0, sets_1.isEqOrIncludes)(mouse, m) && action(m); });
    });
    var onMouseRelease = (0, overload_1.overload2)(function (action) {
        return state.events.on("mouseRelease", function (m) { return action(m); });
    }, function (mouse, action) {
        return state.events.on("mouseRelease", function (m) { return m === mouse && action(m); });
    });
    function onMouseMove(f) {
        return state.events.on("mouseMove", function () { return f(mousePos(), mouseDeltaPos()); });
    }
    ...
    var onGamepadButtonPress = (0, overload_1.overload2)(function (action) {
        return state.events.on("gamepadButtonPress", function (b, gp) { return action(b, gp); });
    }, function (btn, action) {
        return state.events.on("gamepadButtonPress", function (b, gp) { return (0, sets_1.isEqOrIncludes)(btn, b) && action(b, gp); });
    });
    var onGamepadButtonDown = (0, overload_1.overload2)(function (action) {
        return state.events.on("gamepadButtonDown", function (b, gp) { return action(b, gp); });
    }, function (btn, action) {
        return state.events.on("gamepadButtonDown", function (b, gp) { return (0, sets_1.isEqOrIncludes)(btn, b) && action(b, gp); });
    });
    var onGamepadButtonRelease = (0, overload_1.overload2)(function (action) {
        return state.events.on("gamepadButtonRelease", function (b, gp) { return action(b, gp); });
    }, function (btn, action) {
        return state.events.on("gamepadButtonRelease", function (b, gp) { return (0, sets_1.isEqOrIncludes)(btn, b) && action(b, gp); });
    });
    function onGamepadStick(stick, action) {
        return state.events.on("gamepadStick", function (a, v, gp) { return a === stick && action(v, gp); });
    }
    ...
    function getGamepadStick(stick) {
        return state.mergedGamepadState.stickState.get(stick) || new Vec2_1.Vec2(0);
    }
    ...
    var onButtonPress = (0, overload_1.overload2)(function (action) {
        return state.events.on("buttonPress", function (b) { return action(b); });
    }, function (btn, action) {
        return state.events.on("buttonPress", function (b) { return (0, sets_1.isEqOrIncludes)(btn, b) && action(b); });
    });
    var onButtonDown = (0, overload_1.overload2)(function (action) {
        return state.events.on("buttonDown", function (b) { return action(b); });
    }, function (btn, action) {
        return state.events.on("buttonDown", function (b) { return (0, sets_1.isEqOrIncludes)(btn, b) && action(b); });
    });
    var onButtonRelease = (0, overload_1.overload2)(function (action) {
        return state.events.on("buttonRelease", function (b) { return action(b); });
    }, function (btn, action) {
        return state.events.on("buttonRelease", function (b) { return (0, sets_1.isEqOrIncludes)(btn, b) && action(b); });
    });
    ...
    function processInput() {
        ...
        state.keyState.down.forEach(function (k) { return state.events.trigger("keyDown", k); });
    ...
    function registerGamepad(browserGamepad) {
        var gamepad = {
            ...
            isPressed: function (btn) {
                var _a;
                return ((_a = state.gamepadStates.get(browserGamepad.index)) === null || _a === void 0 ? void 0 : _a.buttonState.pressed.has(btn)) || false;
            },
            isDown: function (btn) {
                var _a;
                return ((_a = state.gamepadStates.get(browserGamepad.index)) === null || _a === void 0 ? void 0 : _a.buttonState.down.has(btn)) || false;
            },
            isReleased: function (btn) {
                var _a;
                return ((_a = state.gamepadStates.get(browserGamepad.index)) === null || _a === void 0 ? void 0 : _a.buttonState.released.has(btn)) || false;
            },
            getStick: function (stick) {
                var _a;
                return ((_a = state.gamepadStates.get(browserGamepad.index)) === null || _a === void 0 ? void 0 : _a.stickState.get(stick)) || (0, math_1.vec2)();
            },
        };
    ...
    function processGamepad() {
        ...
        for (var _e = 0, _f = state.gamepads; _e < _f.length; _e++) {
            ...
            if (!browserGamepad)
                continue;
            var customMap = (_a = opt.gamepads) !== null && _a !== void 0 ? _a : {};
            var map_1 = customMap[browserGamepad.id]
                || general_1.GP_MAP[browserGamepad.id] || general_1.GP_MAP["default"];
            ...
            for (var i = 0; i < browserGamepad.buttons.length; i++) {
                ...
                var isGamepadButtonBind = state.buttonsByGamepad.has(gamepadBtn);
                if (browserGamepadBtn.pressed) {
                    if (gamepadState.buttonState.down.has(gamepadBtn)) {
                        state.events.trigger("gamepadButtonDown", gamepadBtn, gamepad);
                        continue;
                    }
                    ...
                    if (isGamepadButtonBind) {
                        ...
                        (_b = state.buttonsByGamepad.get(gamepadBtn)) === null || _b === void 0 ? void 0 : _b.forEach(function (btn) {
                            state.buttonState.press(btn);
                            state.events.trigger("buttonPress", btn);
                        });
                    }
                    ...
                    state.events.trigger("gamepadButtonPress", gamepadBtn, gamepad);
                }
                else if (gamepadState.buttonState.down.has(gamepadBtn)) {
                    if (isGamepadButtonBind) {
                        (_c = state.buttonsByGamepad.get(gamepadBtn)) === null || _c === void 0 ? void 0 : _c.forEach(function (btn) {
                            state.buttonState.release(btn);
                            state.events.trigger("buttonRelease", btn);
                        });
                    }
                    ...
                    state.events.trigger("gamepadButtonRelease", gamepadBtn, gamepad);
                }
            }
            for (var stickName in map_1.sticks) {
                ...
                if (!stick)
                    continue;
                var value = new Vec2_1.Vec2(browserGamepad.axes[stick.x], browserGamepad.axes[stick.y]);
    ...
    canvasEvents.mousemove = function (e) {
        ...
        var mousePos = (0, viewport_1.canvasToViewport)(new Vec2_1.Vec2(e.offsetX, e.offsetY));
        ...
        if (isFullscreen()) {
            ...
            if (rw > rc) {
                ...
                mousePos.x = (0, math_1.map)(e.offsetX - offset, 0, cw * ratio, 0, cw);
                ...
                mousePos.y = (0, math_1.map)(e.offsetY - offset, 0, ch * ratio, 0, ch);
            }
        }
    ...
    canvasEvents.mousedown = function (e) {
        state.events.onOnce("input", function () {
            ...
            if (state.buttonsByMouse.has(m)) {
                (_a = state.buttonsByMouse.get(m)) === null || _a === void 0 ? void 0 : _a.forEach(function (btn) {
                    state.buttonState.press(btn);
                    state.events.trigger("buttonPress", btn);
                });
            }
        ...
        state.events.onOnce("input", function () {
            ...
            if (e.repeat) {
                ...
                if (state.buttonsByKey.has(k)) {
                    (_a = state.buttonsByKey.get(k)) === null || _a === void 0 ? void 0 : _a.forEach(function (btn) {
                        state.buttonState.press(btn);
                        state.events.trigger("buttonPress", btn);
                    });
                }
                if (state.buttonsByKeyCode.has(code)) {
                    (_b = state.buttonsByKeyCode.get(code)) === null || _b === void 0 ? void 0 : _b.forEach(function (btn) {
                        state.buttonState.press(btn);
                        state.events.trigger("buttonPress", btn);
                    });
                }
    ...
    canvasEvents.touchstart = function (e) {
        ...
        state.events.onOnce("input", function () {
            ...
            if (opt.touchToMouse !== false) {
                state.mousePos = (0, viewport_1.canvasToViewport)(new Vec2_1.Vec2(touches[0].clientX - box.x, touches[0].clientY - box.y));
                state.lastInputDevice = "mouse";
                if (state.buttonsByMouse.has("left")) {
                    (_a = state.buttonsByMouse.get("left")) === null || _a === void 0 ? void 0 : _a.forEach(function (btn) {
                        state.buttonState.press(btn);
                        state.events.trigger("buttonPress", btn);
                    });
                }
            ...
            touches.forEach(function (t) {
                state.events.trigger("touchStart", (0, viewport_1.canvasToViewport)(new Vec2_1.Vec2(t.clientX - box.x, t.clientY - box.y)), t);
            });
        });
    };
    canvasEvents.touchmove = function (e) {
        ...
        state.events.onOnce("input", function () {
            ...
            touches.forEach(function (t) {
                state.events.trigger("touchMove", (0, viewport_1.canvasToViewport)(new Vec2_1.Vec2(t.clientX - box.x, t.clientY - box.y)), t);
            });
        });
    };
    canvasEvents.touchend = function (e) {
        state.events.onOnce("input", function () {
            ...
            touches.forEach(function (t) {
                state.events.trigger("touchEnd", (0, viewport_1.canvasToViewport)(new Vec2_1.Vec2(t.clientX - box.x, t.clientY - box.y)), t);
            });
        });
    };
    ...
    canvasEvents.contextmenu = function (e) { return e.preventDefault(); };
    ...
    winEvents.gamepaddisconnected = function (e) {
        var kbGamepad = getGamepads().filter(function (g) { return g.index === e.gamepad.index; })[0];
    ...
    var resizeObserver = new ResizeObserver(function (entries) {
        for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
            ...
            if (entry.target !== state.canvas)
                continue;
            if (state.lastWidth === state.canvas.offsetWidth
