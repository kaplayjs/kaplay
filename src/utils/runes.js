...
function nextUnits(i, string) {
    ...
    if (
        ...
        return string.slice(i).indexOf(
            String.fromCodePoint(917631 /* EnumRunesCode.TAGS_END */),
        ) + 2;
    }
...
function isFirstOfSurrogatePair(string) {
    return string
        && betweenInclusive(
            ...
            55296, /* EnumRunesCode.HIGH_SURROGATE_START */
            56319, /* EnumRunesCode.HIGH_SURROGATE_END */
        );
}
function isRegionalIndicator(string) {
    return betweenInclusive(
        codePointFromSurrogatePair(string),
        127462, /* EnumRunesCode.REGIONAL_INDICATOR_START */
        127487, /* EnumRunesCode.REGIONAL_INDICATOR_END */
    );
}
function isSubdivisionFlag(string) {
    return betweenInclusive(
        codePointFromSurrogatePair(string),
        127988, /* EnumRunesCode.SUBDIVISION_INDICATOR_START */
        127988, /* EnumRunesCode.SUBDIVISION_INDICATOR_START */
    );
}
function isFitzpatrickModifier(string) {
    return betweenInclusive(
        codePointFromSurrogatePair(string),
        127995, /* EnumRunesCode.FITZPATRICK_MODIFIER_START */
        127999, /* EnumRunesCode.FITZPATRICK_MODIFIER_END */
    );
}
function isVariationSelector(string) {
    return typeof string === "string"
        && betweenInclusive(
            string.charCodeAt(0),
            65024, /* EnumRunesCode.VARIATION_MODIFIER_START */
            65039, /* EnumRunesCode.VARIATION_MODIFIER_END */
        );
}
function isDiacriticalMark(string) {
    return typeof string === "string"
        && betweenInclusive(
            string.charCodeAt(0),
            8400, /* EnumRunesCode.DIACRITICAL_MARKS_START */
            8447, /* EnumRunesCode.DIACRITICAL_MARKS_END */
        );
}
function isSupplementarySpecialpurposePlane(string) {
    ...
    return (typeof string === "string" && typeof codePoint === "number"
        && betweenInclusive(
            codePoint,
            917504, /* EnumRunesCode.TAGS_START */
            917631, /* EnumRunesCode.TAGS_END */
        ));
}
...
function codePointFromSurrogatePair(pair) {
    var highOffset = pair.charCodeAt(0)
        - 55296 /* EnumRunesCode.HIGH_SURROGATE_START */;
    var lowOffset = pair.charCodeAt(1)
        - 56320 /* EnumRunesCode.LOW_SURROGATE_START */;
