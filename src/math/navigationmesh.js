...
var NavPolygon = /** @class */ (function () {
    ...
    Object.defineProperty(NavPolygon.prototype, "edges", {
        ...
        set: function (edges) {
            ...
            area /= 2;
            this._centroid = (0, math_1.vec2)(centerX / (6 * area), centerY / (6 * area));
        },
        enumerable: false,
        configurable: true
    });
...
var NavMesh = /** @class */ (function () {
    ...
    NavMesh.prototype._addEdge = function (edge) {
        var key = "".concat(edge.a.x, "_").concat(edge.a.y, "-").concat(edge.b.x, "_").concat(edge.b.y);
        this._edgeCache[key] = edge;
        return edge;
    };
    NavMesh.prototype._findEdge = function (a, b) {
        var key = "".concat(a.x, "_").concat(a.y, "-").concat(b.x, "_").concat(b.y);
    ...
    NavMesh.prototype.addPolygon = function (vertices) {
        ...
        var edges = vertices.map(function (v, index) {
            return new NavEdge(v, vertices[(index + 1) % vertices.length], polygon);
        });
        polygon.edges = edges;
    ...
    NavMesh.prototype.getNeighbours = function (index) {
        var neighbours = [];
        for (var _i = 0, _a = this._polygons[index].edges; _i < _a.length; _i++) {
            var edge = _a[_i];
    ...
    NavMesh.prototype.getWaypointPath = function (start, goal, opt) {
        var _this = this;
        var type = (opt === null || opt === void 0 ? void 0 : opt.type) || "centroids";
        ...
        if (type === "edges") {
            ...
            for (var i = 1; i < path.length; i++) {
                ...
                // TODO: Remove non-null assertion
                edges.push(edge.middle.add(p2.centroid.sub(edge.middle).unit().scale(4)));
            }
            return __spreadArray(__spreadArray([start], edges, true), [goal], false);
        }
        else { // type === "centroids"
