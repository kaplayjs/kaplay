...
function drawRect(opt) {
    ...
    var w = opt.width;
    var h = opt.height;
    var anchor = (0, anchor_1.anchorPt)(opt.anchor || general_1.DEF_ANCHOR).add(
        1,
        1,
    );
    ...
    if (opt.radius) {
        ...
        var r = Array.isArray(opt.radius)
            ? opt.radius.map(function(r) {
                return Math.min(maxRadius_1, r);
            })
            ...
            __spreadArray(
                __spreadArray(
                    __spreadArray(
                        ...
                        r[1]
                            ? (0, various_1.getArcPts)(
                                new Vec2_1.Vec2(w - r[1], r[1]),
                                r[1],
                                r[1],
                                270,
                                360,
