...
function drawRaw(attributes, indices, fixed, tex, shaderSrc, uniform, blend) {
    ...
    var parsedTex = tex !== null && tex !== void 0 ? tex : shared_1._k.gfx.defTex;
    var parsedShader = shaderSrc !== null && shaderSrc !== void 0 ? shaderSrc : shared_1._k.gfx.defShader;
    ...
    for (var i = 0; i < vertLength; i++) {
        ...
        transform.transformPointV(shared_1._k.gfx.scratchPt, shared_1._k.gfx.scratchPt);
    ...
    shared_1._k.gfx.renderer.push(shared_1._k.gfx.ggl.gl.TRIANGLES, vv, indices, shader, parsedTex, uniform, blend !== null && blend !== void 0 ? blend : types_1.BlendMode.Normal, (0, stack_1.width)(), (0, stack_1.height)(), shared_1._k.gfx.fixed || fixed);
}
