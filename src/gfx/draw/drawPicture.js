...
exports.beginPicture = beginPicture;
exports.appendToPicture = appendToPicture;
exports.endPicture = endPicture;
 ...
 */
function drawPicture(picture, opt) {
    var _a, _b;
    var w = (0, stack_1.width)();
    var h = (0, stack_1.height)();
    ...
    ctx.pushArrayBuffer(shared_1._k.gfx.renderer.glVBuf);
...
function endPicture() {
    var ctx = shared_1._k.gfx.renderer.ctx;
    var gl = ctx.gl;
    var picture = shared_1._k.gfx.renderer.picture;
    if (!picture) {
