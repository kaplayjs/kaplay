...
var TexPacker = /** @class */ (function () {
    ...
    TexPacker.prototype.add = function (img) {
        ...
        if (paddedWidth > this.canvas.width || paddedHeight > this.canvas.height) {
        ...
        return [
            curTex,
            new math_1.Quad(pos.x / this.canvas.width, pos.y / this.canvas.height, img.width / this.canvas.width, img.height / this.canvas.height),
    ...
    TexPacker.prototype.remove = function (packerId) {
        ...
        this.c2d.clearRect(tex.position.x, tex.position.y, tex.size.x, tex.size.y);
