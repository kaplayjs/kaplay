...
import type {
    ...
    KaboomCtx,
    KaboomOpt,
    KaboomPlugin, LevelComp,
    LevelOpt,
    LoadBitmapFontOpt,
    LoadFontOpt,
    LoadSpriteOpt,
    LoadSpriteSrc, MergePlugins, MusicData,
    NineSlice,
    Outline,
    PathFindOpt,
    PeditFile,
    ...
    : KaboomCtx<TButtons, TButtonsName> & MergePlugins<TPlugins> =>
{
    ...
    const gameWrapper = {
        current: null as unknown as any | null,
    };
    ...
    const game = initGame(make([]));

    gameWrapper.current = game;
