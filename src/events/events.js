...
exports.KEventHandler =
    exports.KEvent =
    exports.KEventController =
    exports.Registry =
        void 0;
...
var KEvent = /** @class */ function() {
    ...
    KEvent.prototype.trigger = function() {
        ...
        this.handlers.forEach(function(action) {
            ...
            var cancel;
            if (
                result === general_1.EVENT_CANCEL_SYMBOL
...
var KEventHandler = /** @class */ function() {
    ...
    KEventHandler.prototype.numListeners = function(name) {
        var _a, _b;
        return (_b = (_a = this.handlers[name]) === null || _a === void 0
                        ? void 0
                        : _a.numListeners()) !== null && _b !== void 0
            ? _b
            : 0;
    };
