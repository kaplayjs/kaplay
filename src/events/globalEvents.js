...
exports.onClick = exports.onUntag = exports.onTag = exports.onUnuse = exports.onUse = exports.onDestroy = exports.onAdd = exports.onDraw = exports.onUpdate = exports.onFixedUpdate = exports.trigger = void 0;
exports.on = on;
...
function on(event, tag, cb) {
    ...
    return {
        ...
        set paused(p) {
            paused = p;
            obj2Handler.forEach(function (ec) { return ec.paused = p; });
        },
        cancel: function () {
            obj2Handler.forEach(function (ec) { return ec.cancel(); });
            obj2Handler.clear();
            ecOnTag.cancel();
            ecOnUntag.cancel();
        },
...
var trigger = function (event, tag) {
    ...
    for (var _a = 0, _b = shared_1._k.game.root.children; _a < _b.length; _a++) {
        var obj = _b[_a];
        if (obj.is(tag)) {
...
exports.onFixedUpdate = (0, overload_1.overload2)(function (action) {
    ...
    return {
        ...
        cancel: function () { return obj.destroy(); },
    };
}, function (tag, action) {
...
function onCollide(t1, t2, f) {
    return on("collide", t1, function (a, b, col) { return b.is(t2) && f(a, b, col); });
}
function onCollideUpdate(t1, t2, f) {
    return on("collideUpdate", t1, function (a, b, col) { return b.is(t2) && f(a, b, col); });
}
function onCollideEnd(t1, t2, f) {
    return on("collideEnd", t1, function (a, b, col) { return b.is(t2) && f(a, b, col); });
}
...
exports.onClick = (0, overload_1.overload2)(function (action) {
    ...
    forAllCurrentAndFuture(tag, function (obj) {
        ...
        events.push(obj.onClick(function () { return action(obj); }));
    });
...
function onHover(t, action) {
    ...
    forAllCurrentAndFuture(t, function (obj) {
        ...
        events.push(obj.onHover(function () { return action(obj); }));
    });
    return events_1.KEventController.join(events);
}
// add an event that runs once when objs with tag t is hovered
function onHoverUpdate(t, action) {
    ...
    forAllCurrentAndFuture(t, function (obj) {
        ...
        events.push(obj.onHoverUpdate(function () { return action(obj); }));
    });
    return events_1.KEventController.join(events);
}
...
function onHoverEnd(t, action) {
    ...
    forAllCurrentAndFuture(t, function (obj) {
        ...
        events.push(obj.onHoverEnd(function () { return action(obj); }));
    });
    return events_1.KEventController.join(events);
}
...
function onLoadError(cb) {
    if (shared_1._k.assets.loaded) {
        (0, asset_1.getFailedAssets)().forEach(function (asset) { return cb.apply(void 0, asset); });
    }
    else {
