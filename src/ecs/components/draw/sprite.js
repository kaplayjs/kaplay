...
function sprite(src, opt) {
    ...
    return {
        ...
        draw: function () {
            ...
            if (!spriteData)
                return;
            var q = spriteData.frames[(_a = this.frame) !== null && _a !== void 0 ? _a : 0];
            if (!q) {
                throw new Error("Frame not found: ".concat((_b = this.frame) !== null && _b !== void 0 ? _b : 0));
            }
            if (spriteData.slice9) {
                // TODO: tile
                // TODO: use scale or width / height, or both?
                var _d = spriteData.slice9, left = _d.left, right = _d.right, top_1 = _d.top, bottom = _d.bottom;
                ...
                var offset = (0, anchor_1.anchorPt)(props.anchor || general_1.DEF_ANCHOR);
                ...
                (0, drawTexture_1.drawTexture)(Object.assign((0, utils_1.getRenderProps)(this), {
                    tex: spriteData.tex,
                    quad: q.scale((_c = this.quad) !== null && _c !== void 0 ? _c : new math_1.Quad(0, 0, 1, 1)),
                    flipX: this.flipX,
                    flipY: this.flipY,
                    tiled: opt.tiled,
                    width: this.width,
        ...
        add: function () {
            ...
            if (spr) {
                // The sprite exists
                spr.onLoad(function (spr) { return setSpriteData(_this, spr); });
            }
            else {
                // The sprite may be loaded later in the script, check again when all resources have been loaded
                (0, globalEvents_1.onLoad)(function () { return setSpriteData(_this, (0, sprite_1.resolveSprite)(src).data); });
            }
        },
        update: function () {
            if (!spriteData || !curAnim || curAnimDir === null) {
        ...
        play: function (name, opt) {
            ...
            if (opt === void 0) { opt = {}; }
            if (!spriteData) {
                spriteLoadedEvent.add(function () { return _this.play(name, opt); });
                return;
            }
            ...
            curAnim = typeof anim === "number"
                ...
                : {
                    name: name,
                    timer: 0,
                    loop: (_b = (_a = opt.loop) !== null && _a !== void 0 ? _a : anim.loop) !== null && _b !== void 0 ? _b : false,
                    pingpong: (_d = (_c = opt.pingpong) !== null && _c !== void 0 ? _c : anim.pingpong) !== null && _d !== void 0 ? _d : false,
                    speed: (_f = (_e = opt.speed) !== null && _e !== void 0 ? _e : anim.speed) !== null && _f !== void 0 ? _f : 10,
                    frameIndex: 0,
                    onEnd: (_g = opt.onEnd) !== null && _g !== void 0 ? _g : (function () { }),
                };
        ...
        numFrames: function () {
            var _a;
            return (_a = spriteData === null || spriteData === void 0 ? void 0 : spriteData.frames.length) !== null && _a !== void 0 ? _a : 0;
        },
        getCurAnim: function () {
            return curAnim;
        },
        curAnim: function () {
            return curAnim === null || curAnim === void 0 ? void 0 : curAnim.name;
        },
        getAnim: function (name) {
            var _a;
            return (_a = spriteData === null || spriteData === void 0 ? void 0 : spriteData.anims[name]) !== null && _a !== void 0 ? _a : null;
        },
