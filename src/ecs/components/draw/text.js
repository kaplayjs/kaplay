...
function text(t, opt) {
    ...
    function update(obj) {
        var _a, _b;
        theFormattedText = (0, formatText_1.formatText)(Object.assign((0, utils_1.getRenderProps)(obj), {
            text: obj.text + "",
            size: obj.textSize,
            font: obj.font,
        ...
        if (!opt.width) {
            obj.width = theFormattedText.width / (((_a = obj.scale) === null || _a === void 0 ? void 0 : _a.x) || 1);
        }
        obj.height = theFormattedText.height / (((_b = obj.scale) === null || _b === void 0 ? void 0 : _b.y) || 1);
    }
    var _shape;
    ...
    var obj = {
        ...
        textSize: (_b = opt.size) !== null && _b !== void 0 ? _b : general_1.DEF_TEXT_SIZE,
        font: opt.font,
        get width() {
            return _width;
        },
        ...
        add: function () {
            var _this = this;
            (0, globalEvents_1.onLoad)(function () { return update(_this); });
        },
        draw: function () {
