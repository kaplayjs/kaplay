...
function sentry(candidates, opts) {
    ...
    return {
        ...
        hasLineOfSight: function (obj) {
            var hit = (0, raycast_1.raycast)(this.pos, obj.pos.sub(this.pos), opts.raycastExclude);
        ...
        update: function () {
            ...
            if (t > checkFrequency) {
                ...
                if (objects.length && directionVector && this.fieldOfView
                    && this.fieldOfView < 360) {
                    var halfAngle_1 = this.fieldOfView / 2;
                    objects = objects.filter(function (o) {
                        return o.pos
                            && directionVector.angleBetween(o.pos.sub(_this.pos))
                                <= halfAngle_1;
                    });
                }
