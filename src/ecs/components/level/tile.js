...
function tile(opts) {
    ...
    var isObstacle = (_a = opts.isObstacle) !== null && _a !== void 0 ? _a : false;
    ...
    var getEdgeMask = function () {
        ...
        return edges.map(function (s) { return loopup[s] || 0; }).reduce(function (mask, dir) { return mask | dir; }, 0);
    };
    var edgeMask = getEdgeMask();
    return {
        id: "tile",
        tilePosOffset: (_d = opts.offset) !== null && _d !== void 0 ? _d : (0, math_1.vec2)(0),
        set tilePos(p) {
            var level = this.getLevel();
            tilePos = p.clone();
            // @ts-ignore
            this.pos = (0, math_1.vec2)(this.tilePos.x * level.tileWidth(), this.tilePos.y * level.tileHeight()).add(this.tilePosOffset);
        },
        get tilePos() {
            return tilePos;
        },
