...
var AnimateChannel = /** @class */ function() {
     ...
     * @returns The first key index for the given time, as well as the relative time towards the second key.
     */
    AnimateChannel.prototype.getLowerKeyIndexAndRelativeTime = function(
        t,
        count,
        timing,
    ) {
    ...
    AnimateChannel.prototype.serialize = function() {
        ...
        if (this.easings) {
            serialization.easings = this.easings.map(function(e) {
                return _this.easing.name;
            });
        }
...
var AnimateChannelNumber = /** @class */ function(_super) {
    ...
    AnimateChannelNumber.prototype.update = function(obj, t) {
        var _a = this.getLowerKeyIndexAndRelativeTime(
                t,
                this.keys.length,
                this.timing,
            ),
    ...
    function AnimateChannelVec2(name, keys, opts, relative, followMotion) {
        ...
        if (_this.interpolation === "spline") {
            ...
            for (var i = 0; i < _this.keys.length - 1; i++) {
                ...
                if (followMotion) {
                    (_a = _this.dcurves) === null || _a === void 0
                        ? void 0
                        : _a.push(
                            (0, math_1.catmullRom)(
                                prevPrevKey,
    ...
    AnimateChannelColor.prototype.update = function(obj, t) {
        ...
        if (alpha == 0 || this.interpolation == "none") {
            ...
            this.setValue(
                obj,
                this.name,
                this.keys[index].lerp(this.keys[index + 1], easing(alpha)),
            );
        }
        return isFinished;
    };
...
function animate(gopts) {
    ...
    return {
        ...
        animation: {
            ...
            get duration() {
                return channels.reduce(function(acc, channel) {
                    return Math.max(channel.duration, acc);
                }, 0);
            },
        },
        add: function() {
        ...
        update: function() {
            ...
            for (
                var _i = 0, channels_1 = channels;
                _i < channels_1.length;
                _i++
            ) {
                var c = channels_1[_i];
...
function serializeAnimation(obj, name) {
    ...
    if (obj.children.length > 0) {
        serialization.children = obj.children.filter(function(o) {
            return o.has("named");
        }).map(function(o) {
            return serializeAnimation(o, o.name);
        });
    }
    return serialization;
}
    ...
    if (typeof keys[0] == "number") {
        ...
        if (keys[0].length == 2) {
            return keys.map(function(k) {
                return new Vec2_1.Vec2(k[0], k[1]);
            });
        }
        else if (keys[0].length == 3) {
            return keys.map(function(k) {
                return new color_1.Color(k[0], k[1], k[2]);
            });
        }
    }
}
function deserializeOptions(options) {
    ...
    if (options.easings) {
        options.easings = options.easings.map(function(e) {
            return easings_1.easings[e];
        });
    }
    return options;
}
