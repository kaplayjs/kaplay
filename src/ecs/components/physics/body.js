...
function body(opt) {
    ...
    return {
        ...
        jumpForce: (_b = opt.jumpForce) !== null && _b !== void 0
            ? _b
            : general_1.DEF_JUMP_FORCE,
        gravityScale: (_c = opt.gravityScale) !== null && _c !== void 0
            ? _c
            : 1,
            ...
            if (this.has("area")) {
                ...
                this.onCollideUpdate(function(other, col) {
                    ...
                    if (_this.isStatic && other.isStatic) {
                        ...
                        _this.pos = _this.pos.add(
                            col.displacement.scale(other.mass / tmass),
                        );
                        other.pos = other.pos.add(
                            col.displacement.scale(-_this.mass / tmass),
                        );
                        ...
                        (0, various_1.calcTransform)(
                            col2.source,
                            col2.source.transform,
                        );
                    }
                    col.resolved = true;
                ...
                this.onPhysicsResolve(function(col) {
                    ...
                    if (_this.vel.dot(col.normal) < 0) {
                        ...
                        _this.vel = rejection.sub(
                            projection.scale(restitution),
                        );
                    }
                    if (friction != 0) {
        ...
        update: function() {
            ...
            if (dt) {
                ...
                if (this.pos.x == prevDrawPos.x) {
                    ...
                    this.pos.x = (0, lerp_1.lerp)(
                        prevPhysicsPos.x,
                        nextPhysicsPos.x,
                        dt / shared_1._k.app.fixedDt(),
                    );
        ...
        fixedUpdate: function() {
            ...
            if (shared_1._k.game.gravity && !this.isStatic) {
                ...
                this.vel = this.vel.add(
                    shared_1._k.game.gravity.scale(
                        this.gravityScale * shared_1._k.app.dt(),
                    ),
                );
                // Clamp velocity
                var maxVel = (_a = opt.maxVelocity) !== null && _a !== void 0
                    ? _a
                    : general_1.MAX_VEL;
                ...
                if (
                    prevVel.dot(shared_1._k.game.gravity) < 0
            ...
            if (rDt) {
                ...
                nextPhysicsPos = this.pos.add(
                    nextVel.scale(shared_1._k.app.dt()),
                );
                // Copy to check for changes
                prevDrawPos = this.pos.clone();
            }
        ...
        jump: function(force) {
            ...
            curPlatform = null;
            lastPlatformPos = null;
            this.vel = (0, gravity_1.getGravityDirection)().scale(
