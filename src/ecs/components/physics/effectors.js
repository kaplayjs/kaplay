...
function surfaceEffector(opts) {
    ...
    return {
        ...
        require: ["area"],
        speed: opts.speed,
        speedVariation: (_a = opts.speedVariation) !== null && _a !== void 0 ? _a : 0,
        forceScale: (_b = opts.speedVariation) !== null && _b !== void 0 ? _b : 0.9,
        add: function () {
            var _this = this;
            this.onCollideUpdate(function (obj, col) {
                if (!obj.has("body"))
                    return;
                var dir = col === null || col === void 0 ? void 0 : col.normal.normal();
                var currentVel = obj.vel.project(dir);
                var wantedVel = dir === null || dir === void 0 ? void 0 : dir.scale(_this.speed);
                var force = wantedVel === null || wantedVel === void 0 ? void 0 : wantedVel.sub(currentVel);
                obj.addForce(force === null || force === void 0 ? void 0 : force.scale(obj.mass * _this.forceScale));
            });
        },
    };
}
function areaEffector(opts) {
    ...
    return {
        ...
        useGlobalAngle: (_b = opts.useGlobalAngle) !== null && _b !== void 0 ? _b : true,
        add: function () {
            var _this = this;
            this.onCollideUpdate(function (obj) {
                if (!obj.has("body"))
                    return;
                obj.addForce(_this.useGlobalAngle
                    ? _this.force
...
function pointEffector(opts) {
    ...
    return {
        ...
        distanceScale: (_a = opts.distanceScale) !== null && _a !== void 0 ? _a : 1,
        ...
        add: function () {
            ...
            this.onCollideUpdate(function (obj, col) {
                ...
                var force = dir.scale(_this.forceMagnitude * forceScale / length);
                obj.addForce(force);
                if (_this.linearDrag) {
                    obj.addForce(obj.vel.scale(-_this.linearDrag));
                }
...
function constantForce(opts) {
    ...
    return {
        ...
        require: ["body"],
        force: opts.force,
        useGlobalAngle: (_a = opts.useGlobalAngle) !== null && _a !== void 0 ? _a : true,
        update: function () {
            if (this.force) {
                this.addForce(this.useGlobalAngle
                    ? this.force
...
function platformEffector(opt) {
    var _a, _b;
    if (opt === void 0) { opt = {}; }
    (_a = opt.ignoreSides) !== null && _a !== void 0 ? _a : (opt.ignoreSides = [Vec2_1.Vec2.UP]);
    (_b = opt.shouldCollide) !== null && _b !== void 0 ? _b : (opt.shouldCollide = function (_, normal) {
        var _a;
        return ((_a = opt.ignoreSides) === null || _a === void 0 ? void 0 : _a.findIndex(function (s) { return s.sdist(normal) < Number.EPSILON; }))
            == -1;
    });
    return {
        id: "platformEffector",
        ...
        add: function () {
            ...
            this.onBeforePhysicsResolve(function (collision) {
                ...
                else if (!opt.shouldCollide.call(_this, collision.target, collision.normal)) {
                    collision.preventResolution();
...
function buoyancyEffector(opts) {
    ...
    return {
        ...
        angularDrag: (_c = opts.angularDrag) !== null && _c !== void 0 ? _c : 0.2,
        flowAngle: (_d = opts.flowAngle) !== null && _d !== void 0 ? _d : 0,
        flowMagnitude: (_e = opts.flowMagnitude) !== null && _e !== void 0 ? _e : 0,
        flowVariation: (_f = opts.flowVariation) !== null && _f !== void 0 ? _f : 0,
        add: function () {
            var _this = this;
            this.onCollideUpdate(function (obj, col) {
                if (!obj.has("body"))
                ...
                var _a = polygon.cut((0, math_1.vec2)(-100, _this.surfaceLevel), (0, math_1.vec2)(100, _this.surfaceLevel)), submergedArea = _a[0], _ = _a[1];
                if (submergedArea) {
                    _this.applyBuoyancy(o, submergedArea);
                    _this.applyDrag(o, submergedArea);
                }
                if (_this.flowMagnitude) {
                    o.addForce(Vec2_1.Vec2.fromAngle(_this.flowAngle).scale(_this.flowMagnitude));
                }
            });
        },
