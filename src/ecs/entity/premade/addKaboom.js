...
function addKaboom(p, opt) {
    ...
    if (opt === void 0) opt = {};
    if (
        !shared_1._k.game.defaultAssets.boom
        || !shared_1._k.game.defaultAssets.ka
    ) {
    ...
    kaboom.add(__spreadArray(
        ...
        (_a = opt.comps) !== null && _a !== void 0 ? _a : [],
        true,
    ));
    var ka = kaboom.add(__spreadArray(
        ...
        (_b = opt.comps) !== null && _b !== void 0 ? _b : [],
        true,
    ));
    ka.wait(0.4 / speed, function() {
        return ka.use((0, boom_1.boom)(speed, s));
    });
    ka.onDestroy(function() {
        return kaboom.destroy();
    });
    return kaboom;
}
