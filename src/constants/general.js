...
exports.MAX_TRIES = exports.GP_MAP = exports.EVENT_CANCEL_SYMBOL = exports.MAX_VEL = exports.DEF_JUMP_FORCE = exports.DEF_OFFSCREEN_DIS = exports.COMP_EVENTS = exports.COMP_DESC = exports.DEF_FRAG = exports.DEF_VERT = exports.FRAG_TEMPLATE = exports.VERT_TEMPLATE = exports.MAX_BATCHED_INDICES = exports.MAX_BATCHED_VERTS = exports.VERTEX_FORMAT = exports.LOG_TIME = exports.LOG_MAX = exports.DEF_FONT_FILTER = exports.DEF_HASH_GRID_SIZE = exports.UV_PAD = exports.SPRITE_ATLAS_HEIGHT = exports.SPRITE_ATLAS_WIDTH = exports.FONT_ATLAS_HEIGHT = exports.FONT_ATLAS_WIDTH = exports.MAX_TEXT_CACHE_SIZE = exports.DEF_TEXT_CACHE_SIZE = exports.DEF_TEXT_SIZE = exports.DBG_FONT = exports.DEF_FONT = exports.BG_GRID_SIZE = exports.DEF_ANCHOR = exports.ASCII_CHARS = void 0;
var gamepad_json_1 = require("../data/gamepad.json");
// some default charsets for loading bitmap fonts
exports.ASCII_CHARS = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
...
var STRIDE = exports.VERTEX_FORMAT.reduce(function (sum, f) { return sum + f.size; }, 0);
...
exports.FRAG_TEMPLATE = "precision mediump float;varying vec2 v_pos;varying vec2 v_uv;varying vec4 v_color;uniform sampler2D u_tex;vec4 def_frag(){vec4 texColor=texture2D(u_tex,v_uv);return vec4((v_color.rgb*texColor.rgb),texColor.a)*v_color.a;}{{user}}void main(){gl_FragColor=frag(v_pos,v_uv,v_color,u_tex);if(gl_FragColor.a==0.0){discard;}}";
exports.DEF_VERT = "vec4 vert(vec2 pos,vec2 uv,vec4 color){return def_vert();}";
exports.DEF_FRAG = "vec4 frag(vec2 pos,vec2 uv,vec4 color,sampler2D tex){return def_frag();}";
