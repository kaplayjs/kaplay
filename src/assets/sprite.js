...
var SpriteData = /** @class */ function() {
    ...
    SpriteData.fromImage = function(data, opt) {
        ...
        var _a = opt.singular
                ...
                : shared_1._k.assets.packer.add(data),
            tex = _a[0],
            quad = _a[1],
            packerId = _a[2];
    ...
    SpriteData.fromURL = function(url, opt) {
        if (opt === void 0) opt = {};
        return (0, asset_1.loadImg)(url).then(function(img) {
            return SpriteData.fromImage(img, opt);
        });
    };
    return SpriteData;
}();
...
function getSprite(name) {
    var _a;
    return (_a = shared_1._k.assets.sprites.get(name)) !== null && _a !== void 0
        ? _a
        : null;
}
        ...
        if (
            ...
            return shared_1._k.assets.sprites.add(
                ...
                Promise.all(src.map(function(s) {
                    ...
                    return createSpriteSheet(images, opt);
                }),
            );
        }
        else {
            return shared_1._k.assets.sprites.addLoaded(
                name,
...
function createSpriteSheet(images, opt) {
    ...
    return SpriteData.fromImage(
        merged,
        __assign(__assign({}, opt), { sliceX: images.length, sliceY: 1 }),
    );
}
