...
> {
    ...
    /**
     * Get the latest device type that triggered the input event.
     *
     * @returns The last input device, or null if no input event has been triggered.
     * @since v3001.0
     */
    getLastDevice(): ButtonBindingDevice | null;
    /**
